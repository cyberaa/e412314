...
pkgdatadir = $(datadir)/stellar-core
pkgincludedir = $(includedir)/stellar-core
pkglibdir = $(libdir)/stellar-core
pkglibexecdir = $(libexecdir)/stellar-core
...
ACLOCAL = ${SHELL} /Users/exceltior/stellar_clone/missing aclocal-1.15
AFL_CLANG = 
AFL_CLANGPP = 
AFL_FUZZ = 
AFL_GCC = 
...
AR = ar
AUTOCONF = ${SHELL} /Users/exceltior/stellar_clone/missing autoconf
AUTOHEADER = ${SHELL} /Users/exceltior/stellar_clone/missing autoheader
AUTOMAKE = ${SHELL} /Users/exceltior/stellar_clone/missing automake-1.15
AWK = awk
CC = clang
CCACHE = 
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2 -Wall -Wno-unused-command-line-argument -Qunused-arguments -Wno-unused-local-typedef -Wno-unknown-warning-option -Werror=unused-result
CLANG_FORMAT = 
CPP = clang -E
CPPFLAGS = 
CXX = clang++
...
CXXFLAGS = -g -O2 -std=c++11  -pthread -Wall -Wno-unused-command-line-argument -Qunused-arguments -Wno-unused-local-typedef -Wno-unknown-warning-option -Werror=unused-result
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = false
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /Users/exceltior/stellar_clone/missing makeinfo
MANIFEST_TOOL = :
...
PACKAGE_BUGREPORT = 
PACKAGE_NAME = stellar-core
PACKAGE_STRING = stellar-core 0.1
PACKAGE_TARNAME = stellar-core
PACKAGE_URL = http://www.stellar.org
PACKAGE_VERSION = 0.1
PATH_SEPARATOR = :
...
abs_builddir = /Users/exceltior/stellar_clone
abs_srcdir = /Users/exceltior/stellar_clone
abs_top_builddir = /Users/exceltior/stellar_clone
abs_top_srcdir = /Users/exceltior/stellar_clone
ac_ct_AR = ar
ac_ct_CC = clang
ac_ct_CXX = clang++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /Users/exceltior/stellar_clone/install-sh
libdir = ${exec_prefix}/lib
libexecdir = ${exec_prefix}/libexec
libmedida_CFLAGS = -I$(top_srcdir)/lib/libmedida/src
libmedida_LIBS = $(top_builddir)/lib/libmedida.a
libpq_CFLAGS = -I/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.13.Internal.sdk/usr/local/include
libpq_LIBS = -lpq
libsodium_CFLAGS = -I$(abs_top_builddir)/lib/libsodium/src/libsodium/include -I$(top_srcdir)/lib/libsodium/src/libsodium/include -I$(top_srcdir)/lib/libsodium/src/libsodium/include/sodium
...
soci_CFLAGS = -I$(top_srcdir)/lib/soci/src/core -I$(top_srcdir)/lib/soci/src/backends/sqlite3 -I$(top_srcdir)/lib/soci/src/backends/postgresql
...
top_builddir = .
top_srcdir = .
xdrpp_CFLAGS = -I$(abs_top_srcdir)/lib/xdrpp -I$(abs_top_builddir)/lib/xdrpp
